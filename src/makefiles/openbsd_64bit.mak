...
OPTIONS_LINK_DEBUG=-g -fsigned-char -m64 -L/usr/local/lib -lpthread -lssl -lcrypto -liconv -lreadline -lz
...
OPTIONS_LINK_RELEASE=-O2 -fsigned-char -m64 -L/usr/local/lib -lpthread -lssl -lcrypto -liconv -lreadline -lz
