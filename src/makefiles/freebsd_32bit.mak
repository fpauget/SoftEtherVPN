...
OPTIONS_LINK_DEBUG=-g -fsigned-char -L/usr/local/lib -L/usr/lib -lpthread -lssl -lcrypto -liconv -lreadline -lz
...
OPTIONS_LINK_RELEASE=-O2 -fsigned-char -L/usr/local/lib -L/usr/lib -lpthread -lssl -lcrypto -liconv -lreadline -lz
